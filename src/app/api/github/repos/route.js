    ...
    const fallbackRepos = [
      {
        ...
        description:
          "Developer collaboration platform built with Next.js, Primer React, and Prisma.",
        private: false,
        language: "JavaScript",
        stargazers_count: 24,
        forks_count: 5,
      ...
      },
      {
        ...
        description:
          "Production-ready Next.js 16 starter kit with TailwindCSS and authentication.",
        private: false,
        language: "TypeScript",
        stargazers_count: 89,
        forks_count: 14,
      ...
      },
      {
        ...
        description:
          "Microservice routing gateway with rate limiting and JWT auth middleware.",
        private: true,
        language: "Go",
        stargazers_count: 12,
        forks_count: 2,
      ...
      },
      {
        ...
        description:
          "Custom UI component library extending GitHub Primer React system.",
        private: false,
        language: "JavaScript",
        stargazers_count: 45,
        forks_count: 8,
      ...
      },
      {
        ...
        description:
          "Autonomous GitHub bot for automated PR reviews and refactoring suggestions.",
        private: true,
        language: "Python",
